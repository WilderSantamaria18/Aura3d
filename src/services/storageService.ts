...
export const DEFAULT_BLOB_SETTINGS: BlobCustomSettings = {
  ...
  // 10 Pro Visual Effects (VisionOS / Liquid Glass layers) - Desactivados por defecto
  shockwaveEnabled: false,
  shockwaveIntensity: 1.0,
  chromaticRingEnabled: false,
  chromaticRingIntensity: 1.0,
  pulseGridEnabled: false,
  pulseGridIntensity: 1.0,
  mercuryTrailsEnabled: false,
  mercuryTrailsIntensity: 1.0,
  constellationEnabled: false,
  constellationIntensity: 1.0,
  plasmaVortexEnabled: false,
  plasmaVortexIntensity: 1.0,
  gravitationalLensEnabled: false,
  gravitationalLensIntensity: 1.0,
