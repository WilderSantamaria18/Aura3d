  ...
  return (
    ...
    >
      <div className="space-y-4 font-sans select-none">
        ...
        <div className="p-3.5 rounded-[12px] bg-cyan-400/[0.04] border border-cyan-400/20 space-y-2">
          <div className="flex items-center justify-between">
            <span className="text-xs font-mono font-medium text-cyan-300 flex items-center gap-1.5">
              <Monitor className="w-3.5 h-3.5" />
              Tu Hardware Detectado
            </span>
            <span className="text-[10px] font-mono uppercase tracking-wider px-2 py-0.5 rounded-[6px] bg-cyan-400/10 text-cyan-300 border border-cyan-400/20">
              {hardware.isIntegrated ? 'GPU Integrada / Modo Ahorro' : 'GPU Dedicada / Acelerada'}
            </span>
          </div>

          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs font-mono pt-1">
            <div className="p-2 rounded-[8px] bg-black/40 border border-white/[0.04]">
              <span className="text-[10px] text-white/65 block">GPU</span>
              <span className="text-white truncate block text-[11px]" title={hardware.gpuName}>
                {hardware.gpuName.replace(/angle\s*\(/i, '').replace(/\)/g, '').slice(0, 18) || 'WebGL2'}
              </span>
            </div>
            <div className="p-2 rounded-[8px] bg-black/40 border border-white/[0.04]">
              <span className="text-[10px] text-white/65 block">CPU Cores</span>
              <span className="text-white block text-[11px]">{cores} Hilos</span>
            </div>
            <div className="p-2 rounded-[8px] bg-black/40 border border-white/[0.04]">
              <span className="text-[10px] text-white/65 block">RAM Estimada</span>
              <span className="text-white block text-[11px]">~{mem} GB+</span>
            </div>
            <div className="p-2 rounded-[8px] bg-black/40 border border-white/[0.04]">
              <span className="text-[10px] text-white/65 block">Escala DPR</span>
              <span className="text-white block text-[11px]">{dpr}x</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs">
          ...
          <div className="p-3.5 rounded-[12px] bg-cyan-400/[0.03] border border-cyan-400/20 space-y-2">
          ...
          <div className="p-3.5 rounded-[12px] bg-amber-400/[0.03] border border-amber-400/20 space-y-2">
          ...
          <div className="p-3.5 rounded-[12px] bg-purple-500/[0.03] border border-purple-500/20 space-y-2">
        ...
        {/* Studio Tip */}
        <div className="p-3 rounded-[10px] bg-white/[0.02] border border-white/[0.04] text-[11px] font-mono text-white/60 flex items-center gap-2">
