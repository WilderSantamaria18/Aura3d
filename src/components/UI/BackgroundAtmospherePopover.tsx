...
import { Image, Upload, Trash2, Sparkles, X, SlidersHorizontal, SunMedium, Gauge } from 'lucide-react';
...
export const BackgroundAtmospherePopover: React.FC = () => {
  ...
  return (
    <div className="relative inline-flex items-center" ref={popoverRef}>
      ...
      {isOpen && (
        <div
          className="absolute right-0 top-full mt-2 w-80 sm:w-96 max-h-[82vh] overflow-y-auto p-4 rounded-2xl bg-[#080b16]/95 backdrop-blur-3xl border border-white/10 shadow-[0_24px_60px_rgba(0,0,0,0.95)] z-50 flex flex-col gap-3.5 animate-in fade-in zoom-in-95 custom-scrollbar"
          style={
            isLucid
              ? {
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 py-2 px-3 rounded-xl bg-white/[0.06] hover:bg-white/[0.1] border border-white/10 text-xs font-mono text-white/90 transition-all hover:border-cyan-400/40"
            >
              <Upload className="w-3.5 h-3.5 text-cyan-400" />
              <span>
                {blobSettings.customBackgroundImage ? 'Cambiar Imagen de Fondo' : 'Subir Imagen de Fondo'}
              </span>
            </button>
          ...
          {blobSettings.customBackgroundImage && (
            <div className="flex flex-col gap-2.5 p-2.5 rounded-xl bg-white/[0.03] border border-white/[0.06]">
              <div className="flex items-center justify-between">
                <span className="text-[11px] font-mono text-white/60">Ajuste de Imagen</span>
              ...
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  className="w-full h-1 bg-white/10 rounded cursor-pointer accent-cyan-400"
                />
              </div>
            </div>
          )}
          ...
          <div className="flex flex-col gap-2.5 pt-2 border-t border-white/[0.08]">
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className="w-full h-1 bg-white/10 rounded cursor-pointer accent-amber-400"
              />
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className="w-full h-1 bg-white/10 rounded cursor-pointer accent-purple-400"
              />
            </div>
          </div>
              ...
              {(
                ...
                return (
                  <button
                    ...
                    className={`py-2 px-1.5 rounded-xl text-[10px] font-mono transition-all text-center border ${
                      isActive
          ...
          <div className="flex flex-col gap-2 pt-2 border-t border-white/[0.08]">
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-mono text-white/50 uppercase tracking-wider">
                Variar con Segundo Efecto (Mezcla)
              </span>
              ...
              {(
                ...
                return (
                  <button
                    ...
                    className={`py-1.5 px-1 rounded-xl text-[9px] font-mono transition-all text-center border ${
                      isActive
