...
- Location: e2e/player-flows.spec.ts:63:3
  ...
  - banner [ref=f1e9]:
    - generic [ref=f1e10]:
      - generic [ref=f1e18]:
        ...
        - generic "En pausa"
      - button "Comandos ⌘K" [ref=f1e21]:
        - generic [ref=f1e24]: Comandos
        - generic [ref=f1e25]: ⌘K
    - generic [ref=f1e26]:
      - button "Seleccionar modo de visualización" [ref=f1e28] [cursor=pointer]:
        - generic [ref=f1e32]: Rainbow Void
      - button "Efectos de Audio y DSP" [ref=f1e36] [cursor=pointer]:
        - generic [ref=f1e39]: Efectos & DSP
      - button "-- Tonalidad | 🌧️ | 🌙 Relajado" [ref=f1e44] [cursor=pointer]:
        - generic [ref=f1e45]: "--"
        - generic [ref=f1e46]: Tonalidad
        - generic [ref=f1e47]: "|"
        - generic [ref=f1e48]: 🌧️
        - generic [ref=f1e50]: "|"
        - generic [ref=f1e51]:
          - generic [ref=f1e52]: 🌙
          - generic [ref=f1e53]: Relajado
    - generic [ref=f1e56]:
      - generic [ref=f1e57]:
        - generic "Analizando tempo de la música (BPM)..." [ref=f1e58]:
          - generic [ref=f1e62]: "---"
          - generic [ref=f1e63]: BPM
        - generic [ref=f1e66]:
          - button "Grabar video MP4" [ref=f1e67]:
            - generic [ref=f1e71]: Rec
          - button "Opciones de grabación" [ref=f1e72]
        - button "Captura Fondo 4K" [ref=f1e75]:
          - generic [ref=f1e79]: 4K
        - button "Tarjeta 9:16 para Historias" [ref=f1e80]:
          - generic [ref=f1e84]: 9:16
      - button "Estudio" [ref=f1e86]
      - button "Ajustes de Sistema y Herramientas" [ref=f1e95] [cursor=pointer]:
        - generic [ref=f1e97]: Ajustes
      - generic [ref=f1e100]:
        - button "Switch to Spanish" [ref=f1e101] [cursor=pointer]:
          - generic [ref=f1e105]: en
        - generic [ref=f1e107]:
          - button "Lúcido" [ref=f1e108]
          - button "Desplegar paleta de colores lúcidos" [ref=f1e113]
        - button "Fondo y Atmósfera" [ref=f1e118]:
          - generic [ref=f1e123]: Fondo
      - generic [ref=f1e124]:
        - button "Compartir" [ref=f1e125]
        - button "Modo Galería" [ref=f1e132]
        - button "Pantalla completa" [ref=f1e136]
  - generic [ref=f1e142]:
    - generic [ref=f1e143]:
      - generic [ref=f1e144]: 0:00
      - generic "Arrastra para buscar en la onda sonora o salta a los marcadores de Drop ⚡" [ref=f1e145] [cursor=pointer]:
        - generic:
          - generic "Drop 1 a los 1:10"
        - generic:
          - generic "Drop 2 a los 2:32"
      - generic [ref=f1e307]: 0:00
    - generic [ref=f1e308]:
      - generic [ref=f1e315]:
        - heading "Sin pista seleccionada" [level=4] [ref=f1e317]
        - paragraph [ref=f1e318]: Aura3D Engine
      - generic [ref=f1e319]:
        - button "Activar modo aleatorio" [ref=f1e320] [cursor=pointer]
        - button "Canción anterior" [ref=f1e327] [cursor=pointer]
        - button "Iniciar reproducción" [ref=f1e330] [cursor=pointer]
        - button "Siguiente canción" [ref=f1e333] [cursor=pointer]
        - 'button "Modo de repetición actual: off. Clic para cambiar." [ref=f1e336] [cursor=pointer]'
        - button "Freno de vinilo analógico" [ref=f1e342] [cursor=pointer]
        - button "Bucle DJ A-B" [ref=f1e349] [cursor=pointer]
      - generic [ref=f1e353]:
        - button "Mutear" [ref=f1e354]
        - 'slider "Volumen: 85% (-1.4 dB)" [ref=f1e360] [cursor=pointer]': "0.85"
        - generic [ref=f1e361]: "-1.4 dB"
  - 'generic "Auto-Dock Zen Ghost: Clic para expandir controles de estudio" [ref=f1e363] [cursor=pointer]':
    - generic [ref=f1e364]:
      - generic "En pausa"
    - generic [ref=f1e365]:
      - generic [ref=f1e366]: Aura 3D
      - generic [ref=f1e367]: DAW Studio
    - button "Reproducir" [ref=f1e368]
  - generic [ref=f1e372] [cursor=pointer]:
    - generic [ref=f1e373]:
      - img "Sin reproducción" [ref=f1e375]
      - generic [ref=f1e377]:
        - generic [ref=f1e378]:
          - generic [ref=f1e379]: Sin reproducción
          - generic [ref=f1e380]: Local
        - generic [ref=f1e386]: Aura3D Audio Visualizer • 0:00 / 0:00
    - generic [ref=f1e387]:
      - button "Buscar canciones (YouTube/Spotify)" [ref=f1e388]
      - button "Reproducir" [ref=f1e392]
      - button "Activar Modo Zen (píldora ultracompacta)" [ref=f1e395]
      - button "Expandir Mini-Player" [ref=f1e401]
  - generic:
    - generic:
      - generic:
        - generic:
  ...
  - dialog [ref=f1e404]:
    - generic [ref=f1e405]:
      - generic [ref=f1e406]:
        - generic [ref=f1e408]:
          - generic [ref=f1e409]:
            - heading "Bienvenido a Aura3D Studio" [level=2] [ref=f1e410]
            - generic [ref=f1e411]: ONBOARDING
          - paragraph [ref=f1e412]: Inicialización de tu entorno de visualización y audio inmersivo
        - button "Cerrar modal" [ref=f1e414] [cursor=pointer]
      - generic [ref=f1e419]:
        - generic [ref=f1e420]:
          - generic [ref=f1e421]:
            - generic [ref=f1e422]: "1"
            - generic [ref=f1e423]: Arquitectura
          - generic [ref=f1e424]:
            - generic [ref=f1e425]: "2"
            - generic [ref=f1e426]: Visualizador
          - generic [ref=f1e427]:
            - generic [ref=f1e428]: "3"
            - generic [ref=f1e429]: Comandos
        - generic [ref=f1e430]:
          - generic [ref=f1e431]: Aura3D transforma tu música en esculturas 3D en tiempo real mediante análisis de transformada rápida de Fourier (FFT) y shaders WebGL de precisión milimétrica.
          - generic [ref=f1e436]:
            - generic [ref=f1e437]:
              - generic [ref=f1e438]: Audio Local / Spotify
              - paragraph [ref=f1e444]: Arrastra archivos MP3, WAV, FLAC o conecta tu cuenta de Spotify Premium.
            - generic [ref=f1e445]:
              - generic [ref=f1e446]: DSP & Ecualizador
              - paragraph [ref=f1e449]: Cadena de ecualización analógica de 5 bandas, limitador y spatial audio 3D.
        - generic [ref=f1e450]:
          - button "Omitir introducción" [ref=f1e451] [cursor=pointer]
          - button [ref=f1e453] [cursor=pointer]
  - status [ref=f1e457]: Volumen ajustado al 85%
```
